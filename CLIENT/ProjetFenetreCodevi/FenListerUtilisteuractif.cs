...
{
    public partial class FenListerUtilisteuractif : Form
    {
        public FenListerUtilisteuractif()
        {
            InitializeComponent();
        }
        ...
        private void btnlister_Click(object sender, EventArgs e)
        {
            ...
            //    la = Utilisateur .listerutilisateuractif();
            //    if (la.Count == 0)
            //    {
            //        MessageBox.Show("Il n'existe aucun utilisateur actif!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //    }
            //    else
            //    {
            //        dgvliste.Refresh();
        ...
        private void FenListerUtilisteuractif_Load(object sender, EventArgs e)
        {
            try
            {

                //List<Utilisateur> la = null;
                //la = UtilisateurControleur.listerutilisateuractif();
                //if (la.Count == 0)
                {
                    MessageBox.Show("Il n'existe aucun utilisateur actif!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
