...
{
    public partial class FenListerTransaction : Form
    {
        public FenListerTransaction()
        {
            InitializeComponent();
        }
        ...
        private void btnlister_Click(object sender, EventArgs e)
        {
            ...
            //string requet = "select * from transaction";
        ...
        private void FenListerTransaction_Load(object sender, EventArgs e)
        {
            string requet = "select * from transaction";
